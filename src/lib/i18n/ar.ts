...
export const ar: Record<TranslationKey, string> = {
  ...
  "admin.billing.trial_alerts": "التجربة المجانية والتنبيهات",
  "admin.billing.trial_recs": "توصيات التجربة",
  "admin.billing.trial_clock": "مؤقّت التجربة (دقائق، 0=معطّل)",
  ...
  "account.tg_line_free": "الحالة: Free · الرصيد: {balance} كريدت · التجربة: متبقي {remaining} من {limit}",
  "ads.label": "إعلان",
  ...
  "billing.trial_line": "تجربة مجانية — متبقي {remaining} من {limit} توصيات",
