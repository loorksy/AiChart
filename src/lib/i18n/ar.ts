...
export const ar: Record<TranslationKey, string> = {
  ...
  "support.empty_title": "ابدأ محادثة مع فريق الدعم",
  ...
  "account.tg_line_free": "الحالة: Free · الرصيد: {balance} كريدت",
  "ads.label": "إعلان",
  ...
  "billing.signup_grant_note": "الحسابات الجديدة تبدأ بـ {credits} كريدت — تُنفق على أي عملية بأسعارها العادية.",
