...
export const ar: Record<TranslationKey, string> = {
  ...
  "synth.stop_widened":
    "وُسِّع وقف الخسارة إلى {stop}: المسافة التي وضعتها البنية كانت أقل من الحد الأدنى ({floor} نقطة) فكانت شمعة ارتدادية واحدة تكفي لإلغاء الصفقة.",
  ...
  "orch.one_rec_per_session":
    "توصية واحدة لكل محادثة: التوصية الحالية ({direction} عند {entry}) ما زالت قائمة، فلن أُصدر توصية ثانية حتى تنتهي بهدف أو وقف أو بانتهاء مدتها. ما يلي رأيي في السوق فقط وليس توصية جديدة.",
  ...
  "support.rate.prompt": "كيف كانت تجربتك مع الدعم؟",
  "support.rate.submit": "إرسال التقييم",
  "support.rate.thanks": "شكراً لتقييمك.",
  "support.rate.star": "نجمة {n}",
  "support.rate.error": "تعذّر إرسال التقييم — حاول مرة أخرى.",
  "decision.buy": "شراء",
  "decision.sell": "بيع",
