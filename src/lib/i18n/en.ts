...
export const en = {
  ...
  "admin.billing.trial_alerts": "Free trial and alerts",
  "admin.billing.trial_recs": "Trial recommendations",
  "admin.billing.trial_clock": "Trial clock (minutes, 0 = off)",
  ...
  "account.tg_line_free": "Status: Free · Balance: {balance} credits · Trial: {remaining} of {limit} left",
  "ads.label": "Ad",
  ...
  "billing.trial_line": "Free trial — {remaining} of {limit} recommendations left",
