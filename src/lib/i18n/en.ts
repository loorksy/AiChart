...
export const en = {
  ...
  "synth.stop_widened":
    "Stop widened to {stop}: the distance structure gave was under the floor ({floor} points), so a single rejection candle would have decided the trade.",
  ...
  "support.rate.prompt": "How was your experience with support?",
  "support.rate.submit": "Send rating",
  "support.rate.thanks": "Thank you for the rating.",
  "support.rate.star": "{n} star",
  "support.rate.error": "Could not send the rating — try again.",
  "decision.buy": "Buy",
  "decision.sell": "Sell",
  ...
  "rec.status.tp_band_hit": "Target counted as reached within {gap} points — printed {price}",
  ...
  "rec.tip.tp1": "After TP1 is reached (on gold a 10–15 point zone counts as a touch), consider moving stop loss to breakeven.",
  ...
  "profit_card.badge": "Profit Card",
  "profit_card.unrealized": "Unrealized PnL",
  "profit_card.realized": "Realized PnL",
  "profit_card.long": "Long",
  "profit_card.short": "Short",
  "profit_card.last_price": "Last price",
  "profit_card.hit_price": "Hit price",
  "profit_card.date": "Date",
  "profit_card.share": "Share",
  "profit_card.download": "Download",
  "profit_card.copy_link": "Copy link",
  "profit_card.link_copied": "Link copied",
  "profit_card.share_title": "Lonora profit card",
  "profit_card.tagline": "The smart trading platform",
  "profit_card.failed": "Could not create the image — you can still download after a moment, or copy the link.",
  "profit_card.share_result": "Share result",
  "rec_card.badge": "Recommendation",
  "rec_card.share": "Share recommendation",
  "rec_card.download": "Download",
  "rec_card.link_copied": "Link copied",
  "rec_card.share_title": "Lonora recommendation",
  "rec_card.failed": "Could not create the image — you can still download after a moment, or copy the link.",
  ...
  "visual.line.reviewed": "Visual review: the agent reviewed its own TradingView chart.",
  "visual.line.reviewed_frames": "Visual review: the agent reviewed its own TradingView chart (timeframes: {frames}).",
  "visual.line.contradicted_plain": "Visual review: the chart contradicted the numeric read — displayed confidence was reduced accordingly.",
  "visual.line.not_reviewed": "No visual review: no chart snapshot was captured for this analysis — numeric analysis only.",
  "visual.dimension.reviewed": "Chart snapshots were reviewed.",
  "visual.dimension.reviewed_frames": "Chart snapshots were reviewed (timeframes: {frames}).",
  "visual.dimension.contradicted": "The image contradicted the numeric read.",
  "visual.dimension.not_reviewed": "Chart snapshots were not reviewed in this analysis.",
  "agent.signal.show_report": "Show report",
  "agent.signal.close_report": "Close report",
  "agent.report.title": "Recommendation report",
