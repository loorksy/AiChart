...
/**
 * Live + historical candles for a forex/metal/crypto-CFD instrument from
 * OANDA. No caching, no staleness window, no request limit beyond OANDA's
 * own 5000-candle-per-call cap — every call goes live.
 */
 ...
 * Callers must still intersect this with the platform's fixed 20-symbol
 * allowlist (markets/forexInstruments.ts) — OANDA's own catalogue is far
 * broader than what this platform trades.
 */
