 ...
 * widget. Library features own symbol legend and resolution. Orders are sent
 * only by the agent — the chart must never expose buy/sell or other
 * chart-owned trading controls (not a license gap; product decision).
 */
