    ...
    <PublicChrome skipTargetId="privacy-main" showFooter>
      ...
      >
        ...
        <section className="space-y-5 text-sm leading-7 text-white/80">
          ...
          <div>
            <h2 className="mb-1 font-semibold text-white">ملفات تعريف الارتباط</h2>
            <p>
              نضع ملف ارتباط أساسي أول الطرف لتعريف الزائر بشكل مجهول، فقط لنعدّ
              المتواجدين الآن والزوار الفريدين اليوم على الصفحات العامة. لا نخزّن
              عنوان الإنترنت ولا نستخدم أي متتبعات طرف ثالث.
            </p>
          </div>
          <div>
