      ...
      <section className="space-y-5 text-sm leading-7 text-foreground/90">
        ...
        <div>
          ...
          <p>
            ...
            داخلياً لأغراض تحليلية بحتة فقط (اختبار الاستراتيجيات وبعض أدوات
            المراقبة) ولا يظهر أبداً على شارتك أو في تنفيذ صفقاتك، ووسيطك عبر
            جسر MetaTrader الذي تُشغّله أنت.
          </p>
        </div>
        <div>
