...
const MESSAGES: Record<Locale, Record<string, string>> = {
  ar: {
    ...
    "chat.no_agent_key": "وكيل Claude غير مُفعّل — أضِف ANTHROPIC_API_KEY من لوحة الإدارة.",
  ...
  en: {
    ...
    "chat.no_agent_key": "Claude Agent not active — add ANTHROPIC_API_KEY from Admin Panel.",
