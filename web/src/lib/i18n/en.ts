...
export const en = {
  ...
  "agent.model_hint": "Applies to AiChart trading analysis only — does not replace the MCP host model. Higher = smarter and slower.",
  "agent.reasoning_label": "Reasoning",
  "agent.reasoning_fixed": "No reasoning control",
  "agent.reasoning_hint": "Extra high / max can take several minutes — the model is allowed to finish thinking.",
  "agent.model_loading": "Loading models…",
  "agent.model_load_failed": "Could not load model list.",
  "agent.model_unavailable": "No models available to select right now.",
  "agent.model_retry": "Retry",
