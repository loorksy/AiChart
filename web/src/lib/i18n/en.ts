...
export const en = {
  ...
  "qa.chat.strategy.auto_active": "Active on your scans",
  "qa.chat.strategy.pause_cta": "Pause",
  "qa.chat.strategy.pausing": "Pausing…",
  ...
  // Quant Agent — automated bots
  "qa.tabs.bots": "Bots",
  "qa.bots.title": "Automated bots",
  "qa.bots.subtitle": "Configure a grid, DCA or martingale bot, replay it, and arm it bot-by-bot.",
  "qa.bots.simulation_banner.title": "Simulation",
  "qa.bots.simulation_banner.body": "This bot is in simulation. A run replays your configuration against historical candles. Move a bot to live yourself when you want it to place orders through the platform's normal execution path.",
  "qa.bots.simulation_badge": "Simulation",
  "qa.bots.status.simulation_title": "Simulation",
  "qa.bots.status.simulation_body": "This bot will not place orders. A run replays your configuration against historical candles. The linked account type is shown so you always know where a live arming would send orders.",
  "qa.bots.status.simulation_badge": "Simulation",
  "qa.bots.status.live_title": "Live",
  "qa.bots.status.live_body": "This bot is armed. Orders go through the platform's normal execution path (kill switch, sizing, intent lock). Demo or real follows the linked broker account — there is no separate bot toggle for that.",
  "qa.bots.status.live_badge": "Live",
  "qa.bots.mode.set_live": "Arm live",
  "qa.bots.mode.set_simulation": "Back to simulation",
  "qa.bots.mode.failed": "Could not change this bot's mode.",
