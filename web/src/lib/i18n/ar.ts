...
export const ar: Record<TranslationKey, string> = {
  ...
  // Quant Agent — الروبوتات الآلية (محاكاة فقط)
  "qa.tabs.bots": "الروبوتات",
  "qa.bots.title": "الروبوتات الآلية",
  "qa.bots.subtitle": "اضبط روبوت شبكة أو تكلفة متوسطة أو مضاعفة، ثم أعِد تشغيله على شموع حقيقية.",
  "qa.bots.simulation_banner.title": "محاكاة فقط",
  "qa.bots.simulation_banner.body": "هذه الروبوتات لا تنفّذ أي أمر إطلاقًا. التشغيل يعيد تمثيل إعداداتك على شموع تاريخية ويعرض ما كان سيحدث. لا يوجد تنفيذ حقيقي للروبوتات في AiChart.",
