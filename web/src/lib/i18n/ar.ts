...
export const ar: Record<TranslationKey, string> = {
  ...
  "agent.model_label": "النموذج",
  "agent.model_hint": "ينطبق على تحليل التداول في AiChart فقط — لا يستبدل نموذج مضيف MCP. أعلى = أذكى وأبطأ.",
  "agent.reasoning_label": "التفكير",
  "agent.reasoning_fixed": "بدون ضبط تفكير",
  "agent.reasoning_hint": "عالي جداً/أقصى يحتاج دقائق — النموذج يكمل التفكير دون قطع مبكر.",
  "agent.model_loading": "جارٍ تحميل النماذج…",
  "agent.model_load_failed": "تعذّر تحميل قائمة النماذج.",
  "agent.model_unavailable": "لا نماذج متاحة للاختيار حالياً.",
  "agent.model_retry": "إعادة المحاولة",
  "agent.model_save_failed": "تعذّر حفظ اختيار النموذج.",
