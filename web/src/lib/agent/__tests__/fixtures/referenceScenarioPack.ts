...
export const REFERENCE_SCENARIOS: ReferenceScenario[] = [
  ...
  {
    id: "deep_research_revises",
    title: "بحث عميق يعدل خطة",
    fixture: {
      symbol: "EURUSD",
      interval: "15m",
      shape: "range",
    ...
    expected: {
      revisionCount: 2,
      transition: "entry_updated",
      notificationEvent: "entry_updated",
      notificationCount: 2,
    },
    forbidden: ["silent replacement", "old revision still executable"],
  },
  {
  ...
  {
    id: "stale_revision_execution",
    title: "محاولة تنفيذ stale revision",
    fixture: {
      symbol: "EURUSD",
      interval: "15m",
      shape: "trend_up",
    ...
    expected: { transition: "stale_revision", notificationCount: 1 },
    forbidden: ["silent stale execution"],
  },
  {
    id: "auto_conditional",
    title: "auto + conditional",
    fixture: {
      symbol: "EURUSD",
      interval: "15m",
      shape: "mid_range",
    ...
    expected: { planType: "conditional", executionState: "awaiting_activation" },
    forbidden: ["early auto execution", "execute expired/invalidated"],
  },
  {
    id: "advisory_mode",
    title: "advisory",
    ...
    expected: { revisionCount: 1, notificationCount: 1 },
    forbidden: ["any broker order"],
  },
  {
    ...
    expected: { revisionCount: 1 },
    forbidden: ["show trade-mode toggle", "MCP asks for mode"],
  },
  {
    id: "disconnect_during_auto",
    title: "انقطاع الاتصال أثناء auto",
    fixture: {
      symbol: "EURUSD",
      interval: "15m",
      shape: "trend_up",
    ...
    expected: { transition: "mode_dropped_to_advisory", notificationCount: 1 },
    forbidden: ["stay auto", "execute after disconnect"],
  },
  {
