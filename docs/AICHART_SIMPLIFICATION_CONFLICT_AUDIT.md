...
- Invalid or unrecoverably stale market data may stop unsupported analysis. Broker disconnection, account authorization failure, broker failure, or sizing failure may stop execution only; none may rewrite an analytical BUY/SELL/WAIT opinion.
