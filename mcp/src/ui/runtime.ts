...
(function () {
  ...
  var I18N = {
    en: {
      ...
      noSymbolHint: "No symbol yet — ask AiChart to show a chart for a pair.",
      ...
      followUpManage: "Open my active trades in AiChart.",
      ...
      tradeReadinessSubtitle: "Technical pre-execution check via AiChart.",
    ...
    ar: {
      ...
      noSymbolHint: "لا يوجد رمز بعد — اطلب من AiChart عرض شارت لرمز معين.",
      ...
      followUpManage: "افتح صفقاتي النشطة في AiChart.",
      ...
      tradeReadinessSubtitle: "فحص تقني قبل التنفيذ عبر AiChart.",
