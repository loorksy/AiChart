...
export const MARKET_TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    domain: "market",
    description:
      "Lists tradable forex instruments from the platform catalogue, with an optional q search filter. When: browsing or searching for a pair. JSON only — not a pair-picker card. Symbols here are unchanged, never canonicalized. read-only. Example: market=forex&q=EUR.",
    inputSchema: {
      market: zMarket,
